/*Question 2 - Find how much amount spent by each customer on film? Write a query to return the customer ID, first name, last name of the customer,
first name, last name of the actor and total spent.
? */
